...
Supervisor只负责运行`app.py`，我们还需要配置Nginx。把配置文件`awesome`放到`/etc/nginx/sites-
available/`目录下：
...
![awesome-run-on-server](http://www.liaoxuefeng.com/files/attachments/001402634913242c40921a39dfd429f89926687533961e7000)
